    ...
    <div class="footer-color">
        <div class="d-flex justify-content-between border_title">
            ...
            <div class="p-2 bd-highlight">
                ...
                <button type="button" class="btn me-2 icon-color">
